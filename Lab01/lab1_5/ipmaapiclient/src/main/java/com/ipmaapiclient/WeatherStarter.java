...
import com.ipmaapiclient.ipma_client.IpmaCityForecast; //may need to adapt package name
import com.ipmaapiclient.ipma_client.IpmaService;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (forecast != null) {
                ...
                logger.info( "max temp for %s is %4.1f %n",
                        firstDay.getForecastDate(),
                        Double.parseDouble(firstDay.getTMax()));
            } else {
